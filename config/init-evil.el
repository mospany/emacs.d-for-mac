...
(add-to-list 'load-path "~/.emacs.d/lib/evil/lib")
(add-to-list 'load-path "~/.emacs.d/lib/evil/evil-surround")
...
(require 'evil-leader)
(evil-leader/set-key
  ;; {{ add by mosp begin, 2015/09/12 13:15:14
  ;windowmove
  "wh" 'windmove-left
  "wl" 'windmove-right
  "wk" 'windmove-up
  ...
  "kb" 'kill-this-buffer
  "sp" 'shell-pop
  "qc" 'qiang-comment-dwim-line
  ;tarbar-group
  "th" 'tabbar-backward-group
  "tl" 'tabbar-forward-group
  "tk" 'tabbar-backward
  "tj" 'tabbar-forward
  ;bookmark
  "mt" 'bm-toggle
  "mj" 'bm-next
  "mk" 'bm-previous
  "m0" 'bm-remove-all-current-buffer
  "ms" 'helm-bookmarks
  "hb" 'helm-back-to-last-point
  ;highlight
  "hc" 'highlight-symbol-at-point
  "h0" 'highlight-symbol-remove-all
  "hn" 'highlight-symbol-next
  "hp" 'highlight-symbol-prev
  "hm" 'highlight-fixmes-mode
  ;
  "kw" 'backward-kill-word
  "kr" 'kill-region
  "qr" 'query-replace-regexp
  "sm" 'set-mark-command
  "id" 'my-insert-date
  "it" 'my-insert-time
  "rf" 'recentf-open-files-in-simply-buffer
  ;multi-term
  "tm" 'multi-term
  "to" 'multi-term-dedicated-open
  ;comment
  "cc" 'comment
  "uc" 'uncomment
  ;org-mode
  ...
  "op" 'org-priority
  ;startdict
  "dv" 'view-stardict-in-buffer
  ;ecb
  "ee" 'ecb-goto-window-edit-last
  "es" 'ecb-goto-window-sources
  "ed" 'ecb-goto-window-directories
  "em" 'ecb-goto-window-methods
  "eh" 'ecb-goto-window-history
  "er" 'ecb-redraw-layout
  ;evernote
  "nc" 'evernote-create-note
  "no" 'evernote-open-note
  "ns" 'evernote-search-note
  "nS" 'evernote-do-saved-search
  "nw" 'evernote-write-note
  "np" 'evernote-post-region
  "nb" 'evernote-browser
  ;code fold/unfold
  "ffa" 'semantic-tag-folding-fold-all
  "fsa" 'semantic-tag-folding-show-all
  "ffb" 'semantic-tag-folding-fold-block
  "fsb" 'semantic-tag-folding-show-block
  "hhb" 'hs-hide-block
  "hsb" 'hs-show-block
  "hdb" 'hide-ifdef-block
  "sdb" 'show-ifdef-block
  ;go-mode
  "ga" 'go-import-add
  "gj" 'godef-jump
  "gp" 'pop-tag-mark
